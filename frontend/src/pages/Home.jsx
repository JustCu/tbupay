              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between gap-2.5 p-3.5 ${
                    index !== transactions.length - 1 ? "border-b border-gray-100/60 dark:border-slate-800/40" : ""
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="text-[10px] text-gray-555 dark:text-gray-400 font-medium whitespace-nowrap leading-none">
  ...
  return (
    ...
    <div className="flex flex-col gap-6 pb-6" {...pull.bind}>
      ...
      <section className="grid grid-cols-4 gap-3">
        ...
        >
          <Users size={24} className="text-primary dark:text-blue-400 my-1 shrink-0" />
        ...
        >
          <MessageSquareWarning size={24} className="text-primary dark:text-blue-400 my-1 shrink-0" />
        ...
        >
          <Lightbulb size={24} className="text-primary dark:text-blue-400 my-1 shrink-0" />
        ...
        {user?.role === "admin" && (
          <>
            ...
            >
              <ClipboardCheck size={24} className="text-primary dark:text-blue-400 my-1 shrink-0" />
            ...
            >
              <Bell size={24} className="text-primary dark:text-blue-400 my-1 shrink-0" />
