...
export default function MainLayout() {
  ...
  return (
    <div className="app-container">
      ...
      <nav className="bottom-nav bg-white dark:bg-[#0f1829] border-t border-gray-100 dark:border-slate-800/80 flex justify-around items-center fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] z-50 px-2">
